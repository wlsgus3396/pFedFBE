...
def generate_Matrix(r, d):
    ...
    mean_x = np.random.normal(0,1,(NUM_USER, d,d))

        

    for i in range(NUM_USER):
        xx = np.random.normal(0,1,(samples_per_user[i],d,d))
...
def main():
    ...
    X, y = generate_Matrix(16,32) # synthetic (0.5, 0.5)
